...
Desktop app which generates a JSON file for [Lockout Bingo](https://lockout.live/) using games from the [Retro Achievements API](https://api-docs.retroachievements.org/). Built using [Avalonia UI](https://docs.avaloniaui.net/).
